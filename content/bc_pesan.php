                        ...
                        <form action="" method="post">
                          ...
                          <div class="mb-3">
                            ...
                            <select id="pesan" name="pesan" class="form-select" required>
                              ...
                              {
                              ?>
                                <option value="<?= $hasil['id']; ?>" <?php if ($hasil['id'] == $pesanId['id_pesan'] ) { echo 'selected'; } ?>><?= $hasil['judul_pesan']; ?></option>
                              <?php $h++; } ?>
                            </select>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="row gy-3">
                              <div class="col-md">
                                <label for="pesan" class="form-label">Pilih Group Telegram</label>
                                  ...
                                  <div class="form-check mt-1">
                                    <input class="form-check-input" type="checkbox" id="group_tele" name="group_tele[<?=  $l; ?>]" value="<?= $data_group['id']; ?>" <?php if ( in_array($data_group['id'], $groups) ) { echo "checked"; } ?>>
                                    <label class="form-check-label" for="group_tele">
                                      <?= $data_group['nama']; ?>
                                    </label>
                                  </div>
